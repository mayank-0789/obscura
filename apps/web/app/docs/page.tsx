    ...
    <article className="mx-auto max-w-[720px]">
      ...
      <section className="mt-14 grid gap-5 md:grid-cols-2">
        <QuickstartCard
          ...
          body="Install @payrail/sdk, drop in your agent's API key, point fetch at a paid endpoint. Payrail handles signing, spend caps, and retries on your behalf."
        ...
        <QuickstartCard
          ...
          body="Install @payrail/merchant-sdk, wrap an Express route with pay.charge({ amount }). The PayAI facilitator verifies and settles payments on Solana. You get USDC in your payout wallet."
